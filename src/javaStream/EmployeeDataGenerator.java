...
import java.util.List;
    ...
    public class EmployeeDataGenerator {
        public static List<Employee> generateSampleData() {
            ...
            employeeList.add(new Employee("Robert Johnson", 8000.0, "Finance", 35, "Male", LocalDate.of(2018, 3, 10)));
            employeeList.add(new Employee("Emily Davis", 25000.0, "Marketing", 25, "Female", LocalDate.of(2021, 1, 5)));
            employeeList.add(new Employee("Michael Brown", 12000.0, "Engineering", 32, "Male", LocalDate.of(2017, 11, 18)));
            employeeList.add(new Employee("Alice Miller", 15000.0, "Sales", 29, "Female", LocalDate.of(2019, 9, 8)));
            employeeList.add(new Employee("David Wilson", 28000.0, "IT", 31, "Male", LocalDate.of(2020, 4, 30)));
            employeeList.add(new Employee("Sophia Davis", 45000.0, "Finance", 28, "Female", LocalDate.of(2018, 7, 12)));
            employeeList.add(new Employee("Henry Johnson", 30000.0, "Engineering", 27, "Male", LocalDate.of(2022, 2, 15)));
            ...
            employeeList.add(new Employee("Neha Chauhan", 109000.0, "Engineering", 25, "Female", LocalDate.of(2024, 2, 24)));
